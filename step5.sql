...
-- 2. Top 5 conditions with the highest average billing, this identifies which medical conditions are most costly on average
SELECT 
    MEDICALCONDITION,
    COUNT(*) AS NUM_CASES,
...
-- 3. Hospital performance.. average stay and billing. This will see which hospitals have longer stays and higher costs
SELECT 
    HOSPITAL,
...
--4. Do older patients stay longer? This will see if there's a trend between age and stay duration
...
--5. This will see if there is a trend in admission type and billing amount
